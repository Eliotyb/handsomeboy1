      ...
      <div class="login-right">
        <div class="login-box">
            ...
            <el-form-item prop="captcha">
              ...
              <div class="captcha-row">
                <el-input
                  ...
                  placeholder="请输入验证码"
                  size="large"
                  class="login-input captcha-input-inline"
                  @keyup.enter="handleLogin"
                  maxlength="4"
                >
                  <template #prefix>
                ...
                <div class="captcha-box" @click="refreshCaptcha" title="点击刷新验证码">
                  <img v-if="captchaImageUrl" :src="captchaImageUrl" alt="验证码" class="captcha-img-inline" />
                  <div v-else class="captcha-loading-inline">
                    <el-icon class="is-loading"><Loading /></el-icon>
                  </div>
                </div>
                <el-button type="primary" size="large" class="refresh-btn-inline" @click="refreshCaptcha" :loading="loadingCaptcha">
                  🔄
                </el-button>
              </div>
            </el-form-item>
          ...
          <div class="login-footer">
            <p>© 2026 PULSE VELOCITY SECKILL. KINETIC PULSE SYSTEM.</p>
...
import { ArrowRight, User, Lock, Key, Loading } from '@element-plus/icons-vue'
    ...
    async refreshCaptcha() {
      ...
      try {
        ...
        if (res.code === 200) {
          ...
          this.captchaImageUrl = res.data.captchaImage
