        ...
        <el-form :model="loginForm" :rules="rules" ref="loginFormRef" class="login-form">
          ...
          <div class="form-item-wrapper">
            <div class="form-label">
              ...
              <el-button type="primary" size="small" class="refresh-captcha-btn" @click="refreshCaptcha" :loading="loadingCaptcha">
                🔄 刷新
              </el-button>
            </div>
            <div class="captcha-wrapper">
              ...
              <div class="captcha-image-box" @click="refreshCaptcha">
                <img v-if="captchaImageUrl" :src="captchaImageUrl" alt="验证码" class="captcha-img" />
...
import { 
  Lightning, User, Lock, View, Hide, ArrowRight, UserFilled, Key, Loading
